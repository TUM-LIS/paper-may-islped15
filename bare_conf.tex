...
We start by evaluating the approximation itself. We want to verify if the methodology allows to efficiently approximate  circuits and if the approximation approaches precisely a desired target precision. Table \ref{fig:optimization_qr} is showing the approximation for benchark circuit ``QR''. 
\begin{figure}[htb]
  \centering
