...
\begin{figure}[htb]
  ...
  \label{fig:power_fpu}
\end{figure}
For our future work, we plan to analyze the definition of coarse-grained power-gating islands, in order to further benefit of the dynamic approximations.
